...
%% Recording Data
 ...
 fprintf (fid, '%1d %6s %1d %2d %8s %8s ', Trial(expTrial).Task, Trial(expTrial).TaskNaming, Trial(expTrial).Shifting,  Trial(expTrial).Shape, Trial(expTrial).ShapeNameGlobal, Trial(expTrial).ShapeNameLocal);
