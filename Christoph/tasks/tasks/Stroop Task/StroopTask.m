...
% Define a task name
TaskName = 'Inhibition - Stroop Task';
...
%     io64(expinfo.ioObj, expinfo.PortAddress,0);% Stop Writing to Output Port
    ...
    % trials
    PracStart1=[expinfo.InstFolder 'PracStart1.jpg'];
    ima=imread(PracStart1, 'jpg');
    dImageWait(expinfo,ima);
 
    PracStart2=[expinfo.InstFolder 'PracStart2.jpg'];
    ima=imread(PracStart2, 'jpg');
    dImageWait(expinfo,ima);
...
%     io64(expinfo.ioObj, expinfo.PortAddress,0);% Stop Writing to Output Port
    ...
    BackUp_Trial     = [expinfo.DataFolder,'Backup\',expinfo.taskName,'Stroop_Trials_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session),'_Block',num2str(expBlock)];
...
% accsessed later
BackUp_PracTrial = [expinfo.DataFolder,'Backup\',expinfo.taskName,'Stroop_PracTrials_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session)];
BackUp_ExpInfo   = [expinfo.DataFolder,'Backup\',expinfo.taskName,'Stroop_ExpInfo_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session)];
if expinfo.showPractice == 1
