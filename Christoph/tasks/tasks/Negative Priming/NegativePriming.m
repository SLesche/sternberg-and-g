...
% Define a task name
TaskName = 'Negative Priming Task';
...
%     io64(expinfo.ioObj, expinfo.PortAddress,0);% Stop Writing to Output Port
    ...
    BackUp_Trial     = [expinfo.DataFolder,'Backup\',expinfo.taskName,'NegativePriming_Trials_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session),'_Block',num2str(expBlock)];
...
% accsessed later
BackUp_PracTrial = [expinfo.DataFolder,'Backup\',expinfo.taskName,'NegativePriming_PracTrials_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session)];
BackUp_ExpInfo   = [expinfo.DataFolder,'Backup\',expinfo.taskName,'NegativePriming_ExpInfo_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session)];
if expinfo.showPractice == 1
