...
%     
    ...
    PracOE1=[expinfo.InstFolder 'PracOE1.jpg'];
    ima=imread(PracOE1, 'jpg');
    dImageWait(expinfo,ima);
    
    PracOE2=[expinfo.InstFolder 'PracOE2.jpg'];
    ima=imread(PracOE2, 'jpg');
    dImageWait(expinfo,ima);
...
%     
    ...
    BackUp_Trial     = [expinfo.DataFolder,'Backup\',expinfo.taskName,'Switching_Trials_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session),'_Block',num2str(expBlock)];
...
% accsessed later
BackUp_PracTrial = [expinfo.DataFolder,'Backup\',expinfo.taskName,'Switching_PracTrials_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session)];
BackUp_ExpInfo   = [expinfo.DataFolder,'Backup\',expinfo.taskName,'Switching_ExpInfo_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session)];
if expinfo.showPractice == 1
