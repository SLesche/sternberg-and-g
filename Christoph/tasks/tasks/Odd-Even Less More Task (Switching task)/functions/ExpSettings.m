...
% Minimum duration of target presentations 
expinfo.MinTarget = 1;

% Maximum allowed reaction time during a trail
expinfo.MaxRT = 3; 

% Minimum duration of the Inter-Trial Interval 
...
expinfo.pracFile = [expinfo.DataFolder,expinfo.taskName,'Switching_Task_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session),pracFile];
expinfo.expFile  = [expinfo.DataFolder,expinfo.taskName,'Switching_Task_S',num2str(expinfo.subject),'_Ses',num2str(expinfo.session),expFile];
end
% End of Function
