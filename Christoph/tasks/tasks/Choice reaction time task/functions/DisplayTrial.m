...
Screen('FrameRect', expinfo.window,expinfo.Colors.gray, expinfo.RectLeft);
Screen('FrameRect', expinfo.window,expinfo.Colors.gray, expinfo.RectRight);
...
if Trial(expTrial).ProbeSide == 1
Screen('FrameRect', expinfo.window,expinfo.Colors.gray, expinfo.RectLeft);
Screen('FrameRect', expinfo.window,expinfo.Colors.gray, expinfo.RectRight); 
    Trial(expTrial).time_probe = TextCenteredOnPos(expinfo,'+',expinfo.centerX-81,expinfo.centerY,expinfo.Colors.gray,next_flip, Trial(expTrial).ProbeStimMaker);
...
fprintf (fid, '%1d %1d %1d %1s ', Trial(expTrial).ProbeSide, Trial(expTrial).ProbeLeft,  Trial(expTrial).ProbeRight, Trial(expTrial).ProbeSideWord);
% Print stimuli and variable timings for ISI & ITI in data dile
fprintf (fid, '%1.3f %1.3f ', Trial(expTrial).FIX, Trial(expTrial).ITI);
